...
class NotificationControllerTest {
    ...
    void getNotifications_customLimitOffset_returns200() throws Exception {
        ...
        Mockito.when(notificationService.getNotifications(5, 2))
                .thenReturn(List.of());
    ...
    void getNotifications_negativeLimit_returns200() throws Exception {
        ...
        Mockito.when(notificationService.getNotifications(-1, 0))
                .thenReturn(List.of());
    ...
    void getNotifications_negativeOffset_returns200() throws Exception {
        ...
        Mockito.when(notificationService.getNotifications(10, -5))
                .thenReturn(List.of());
    ...
    void getNotifications_largeLimitOffset_returns200() throws Exception {
        ...
        Mockito.when(notificationService.getNotifications(1000, 500))
                .thenReturn(List.of());
