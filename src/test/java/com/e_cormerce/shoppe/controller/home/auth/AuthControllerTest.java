...
public class AuthControllerTest {
  ...
  void registerSeller_serviceThrow_returns500() throws Exception {
    ...
    Mockito.doThrow(new RuntimeException("error")).when(authService).registerSeller(Mockito.any());
  ...
  void registerSeller_missingBody_returns400() throws Exception {
    ...
    Mockito.verify(authService, Mockito.never()).registerSeller(Mockito.any());
  }
  ...
  void registerSeller_calledTwice() throws Exception {
    ...
    Mockito.verify(authService, Mockito.times(2)).registerSeller(Mockito.any());
  }
