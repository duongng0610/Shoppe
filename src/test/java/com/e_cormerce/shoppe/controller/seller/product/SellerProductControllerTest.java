...
public class SellerProductControllerTest {
  ...
  void missingVariantImages() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.message").value(ErrorCode.CONFLICT_VARIANT_DATA.getMessage()));
  }
  ...
  @Test
  @WithMockUser(
      authorities = "PERMISSION_CREATE_PRODUCT") // tương ứng với hasAuthority ở PreAuthority
