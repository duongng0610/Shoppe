...
/**
 * Tách tầng repository.
 * Khi test tầng service(bussiness logic ~ không cần chạy server, chỉ cần test chức năng
 * ExtendWith thuộc junit , không phải của spring nên ko có load context.
 * Dùng Mock cho các thuộc tính cần thêm lớp service phụ thuộc và InjectMock cho lớp service test
 */
...
public class AuthServiceTest {
    ...
    void logIn_accountNotFound() {
        ...
        when(accountRepository.findByEmail("email@gmail.com"))
    ...
    void logIn_wrongPassword() {
        ...
        when(bCryptPasswordEncoder.matches("123", "hashedPassword"))
                .thenReturn(false);
