...
public class PaymentService {
    ...
    public String createTransaction(HttpServletRequest request) throws AppException {
        ...
        var event = OrderPayment.builder()
                .order(OrderDto.builder().priceEach(order.getPriceEach()).shipCost(order.getShipCost()).quantity(order.getQuantity()).totalPrice(order.getTotalPrice()).orderName(order.getOrderName()).orderThumbnail(order.getOrderThumbnail()).build())
