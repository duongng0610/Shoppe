...
public class CategoryService {
    ...
    public List<ProductCardResponse> getProductsByCategoryId(String category_id) {
        Category category = categoryRepository.findById(category_id).orElseThrow(() -> new AppException(ErrorCode.NOT_EXISTED_CATEGORY));
        eventPublisher.publishEvent(CategorySearched.builder().category(categoryMapper.toDto(category)));
