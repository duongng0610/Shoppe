...
public class ProductAnalysisService {
  ...
  public List<ProductCardProjection> getTopSellingProducts(int limit, int offset, Integer days) {

    return productRepository.getTopSellingProducts(limit, offset, days);
  }

  public List<ProductCardProjection> getTopSellingProductsOfSeller(
      String sellerId, int limit, int offset, Integer days) {

    return productRepository.getTopSellingProductsOfSeller(sellerId, limit, offset, days);
  }
