...
//        Order o = orderRepository.findById(orderId).orElseThrow(() -> new
// AppException(ErrorCode.NOT_EXISTED_ORDER));
//        if (!authService.getUserId().equals(o.getClient().getId()) &&
// !authService.getUserId().equals(o.getSeller().getId())) {
