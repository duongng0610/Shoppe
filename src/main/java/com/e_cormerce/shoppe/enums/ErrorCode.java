...
public enum ErrorCode {
  ...
  CREATE_SHOP_VALID_REQUEST(
      "Invalid create shop request information", 2021, HttpStatus.BAD_REQUEST),
  ...
  UNABLE_REVIEW_PRODUCT(
      "Unable to review product because order is not existed", 2028, HttpStatus.BAD_REQUEST),
