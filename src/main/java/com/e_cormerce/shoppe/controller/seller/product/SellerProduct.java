...
import com.e_cormerce.shoppe.dto.request.product.UpdateProductRequest;
...
public class SellerProduct {
    ...
    public ResponseEntity<ApiResponse> update(@PathVariable String id, @Valid @RequestBody UpdateProductRequest request) {

        sellerService.updateProduct(id, request);
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.builder().success(true).message("update product successfully").build());
    }
    ...
    public ResponseEntity<ApiResponse> hiddenProduct(@PathVariable String id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.builder().success(true).message("hidden product successfully").build());
    }
    ...
    public ResponseEntity<ApiResponse> unhiddenProduct(@PathVariable String id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.builder().success(true).message("unhidden product successfully").build());
    }
    ...
    public ResponseEntity<ApiResponse> getStatisticProduct(
        ...
        var res = sellerService.getStatisticForSeller(limit, offset);
        return ResponseEntity.status(HttpStatus.OK)
                .body(
                        ApiResponse.builder()
                                .data(res)
    ...
    public ResponseEntity<ApiResponse> analyzeProductGrowth(
        ...
        var result = productAnalysisService.analyzeProductGrowth(productId, days);

        return ResponseEntity.ok(
                ApiResponse.builder()
                        .success(true)
                        .message("Analyze product growth successfully")
                        .data(result)
                        .build());
    }
}
