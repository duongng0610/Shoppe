...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse> searchProductsInCategories(@PathVariable String id, @RequestParam(defaultValue = "10") int limit, @RequestParam(defaultValue = "0") int offset) {
