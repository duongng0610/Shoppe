...
import com.e_cormerce.shoppe.repository.user.*;
...
//                  new InputStreamReader(getClass().getResourceAsStream("/data/init/address.csv"))
//          );
//          String line;
...
//              if (firstLine) { //bo qua phan tu br.readLine() dau tien (ko phai data)
//                  firstLine = false;
//                  continue;
//              }
//              // parse JSON
//              AddressCsv addressCsv = mapper.readValue(line, AddressCsv.class);
//              list.add(addressMapper.toAddress(addressCsv));
//
//              if (list.size() == 1000) {
